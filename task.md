...
Run this command:  
`/telex-invite your-email@example.com` (same way you make submissions)  
...
- To view the interactions with your agents go to:
  `https://api.telex.im/agent-logs/{channel-id}.txt`

The channel-id is the first UUID on the address bar:
